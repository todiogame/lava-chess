        ...
        characters: {
            ...
            fisherman: {
                ...
                spells: [
                    {
                        name: "Hameçon",
                        description: "Attire la première cible en ligne droite."
                    },
                    {
                        name: "Filet de pêche",
            ...
            time_traveler: {
                ...
                spells: [
                    {
                        name: "Machine temporelle",
                        description: "Invoque une machine qui explose, infligeant des dégâts autour d'elle et téléportant le lanceur à son emplacement."
                    },
                    {
