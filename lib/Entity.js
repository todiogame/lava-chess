...
module.exports = class Entity {
    constructor(id, name, team, auras, types, pos, maxHP,
        ...
        this.src = "pics/" + id.toLowerCase() +
            (id.toLowerCase() == "zombie" ? Math.floor(Math.random() * 2) : "")
            + ".png";
    ...
    damage(og) { //all spells deal 1 damage in this game
        if (!this.armor) {
            this.currentHP--;
    ...
    isEthereal() {
        return this.auras.some(a => a.name == "ethereal")
    }
}