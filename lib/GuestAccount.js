...
class GuestAccount {
    constructor(username, level, experience, elo) {
        this.username = username;
        this.level = level || 1;
        this.experience = experience || 0;
        this.elo = elo || BASE_RATING;


        if (this.level >= 5) {
            this.level = 5;
            this.experience = 0;
            this.message = strings.ui.landing_page.please_create_account;
        }
        if (this.elo > 1050) {
            this.elo = 1050
            this.message = strings.ui.landing_page.please_create_account;
    ...
    updateHTML() {
        ...
        document.querySelector("#elo").textContent = this.elo;
