...
module.exports = class Anim {
  ...
  static lavaParticles(cell) {
    ...
    for (var i = 0; i < bubbles; i++) {
      let particle = {
        ...
        moving: true,
        randomPos: true,
        randomx: ()=> r(coords.x+0.045*canvasHeight,coords.x-0.045*canvasHeight),
        randomy: ()=> r(coords.y+0.055*canvasHeight,coords.y-0.055*canvasHeight),
      };
      setTimeout(() => {
        particle.moving = false;
      }, 700);
  ...
  static summonParticles(cell) {
    ...
    for (var i = 0; i < bubbles; i++) {
      let particle = {
        ...
        moving: true,
        randomPos: true,
        randomx: ()=> r(coords.x+0.055*canvasHeight,coords.x-0.055*canvasHeight),
        randomy: ()=> r(coords.y+0.065*canvasHeight,coords.y-0.065*canvasHeight),
      };
      setTimeout(() => {
        particle.moving = false;
      }, 700);
  ...
  static debuffParticles(cell, debuff) {
    const coords = drawing.layout.hexToPixel(cell); // {x,y}
