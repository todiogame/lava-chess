...
function onMouseClicHUD(x, y) {
    ...
    let btnY = buttonSpell.h_offset - buttonSpell.height * 2;
    ...
    for (let i = 0; i < currentPlayer.spells.length; i++) {
        ...
        btnY = buttonSpell.h_offset - buttonSpell.height;
...
module.exports = {
    initMap, playAction, onMouseHoverGame, onMouseClicGame, onMouseClicHUD, clickSpell, clickPassTurnOrRiseLava, clickMove
};