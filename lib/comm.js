...
function clientSendAction(action, cell, spellID, direction) {
    console.log("sending",action,cell)
    let copy = cell ? cell.copy() : undefined;
    clientSocket.send(encode("ACTION", { "kind": action, "cell": copy, "spellID":spellID, "direction":direction}))
}
...
module.exports = {
    clientSocket, getUniqueID, encode, decode, broadcast, handleMessageFromClient, clientSendAction
};