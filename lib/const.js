...
const GAMEDATA = Object.freeze({
    ...
    CHARACTERS: [
        ...
        },
        {
            name: "Shaman",
            spells: [
                { name: "Undead Army", dealSpell: "summon", summon: "zombie", range: 1, rangeMin: 1, cooldown: 2, glyph:1, aoe: "single", canTarget: [TYPES.EMPTY], color: 'GLYPH_DARK', glyphIcon: "tombstoneIcon", description: "Plants a flower that summons a zombie next turn." },
        ...
        },
        {
            ...
            spells: [
                ...
                { name: "Defensive stance", dealSpell: "shield", range: 0, cooldown: 3, aoe: "single", canTarget: [TYPES.PLAYABLE], color: "GLYPH_ORANGE", description: "Shields the caster." },
        ...
        },
        {
            ...
            spells: [
                ...
                { name: "Aegis", dealSpell: "shield", range: 0, cooldown: 3, aoe: "area_1", canTarget: [TYPES.PLAYABLE], color: "GLYPH_ORANGE", description: "Shields the caster and everybody around him." },
        ...
        },
        {
            name: "Troll",
            spells: [
                { name: "Repulsion", dealSpell: "push", range: 2, cooldown: 1, aoe: "single", canTarget: [TYPES.ENTITY], animation: ANIMATIONS.FALL, description: "Pushes a target." },
                { name: "Attraction", dealSpell: "pull", range: 2, rangeMin: 1, cooldown: 1, aoe: "straight_line", onlyFirst: true, canTarget: [TYPES.ENTITY], description: "Pulls first target in a straight line." },
