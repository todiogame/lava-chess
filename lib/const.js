    ...
    CHARACTERS: [
        ...
        },
        {
            ...
            spells: [
                ...
                { name: "Defensive stance", dealSpell: "shield", range: 0, cooldown: 3, aoe: "single", canTarget: [TYPES.VULNERABLE], color: "GLYPH_ORANGE", description: "Shields the caster." },
        ...
        },
        {
            name: "Warrior",
            spells: [
                { name: "Cleave", dealSpell: "damage", range: 0, cooldown: 1, aoe: "cleave", glyph: 1, isAura: true, color: "GLYPH_BROWN", canTarget: [TYPES.ANY], description: "Hits in a curly AOE in front of the caster." },
        ...
        },
        {
            ...
            spells: [
                ...
                { name: "Shotgun", dealSpell: "gasser_shotgun", range: 1, rangeMin: 1, cooldown: 1, aoe: "single", canTarget: [TYPES.ANY], description: "Deals instant damage to a single target in close range and add gas to the cell." },
