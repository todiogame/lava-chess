...
const GAMEDATA = Object.freeze({
    ...
    TABLE_SUMMONS: {
        ...
        "infernal": {
            ...
            spells: [
                { passive: true, cooldown: 0, name: "Flame aura", permanent: true, dealSpell: "damage", aoe: "ring_1", isAura: true, glyph: 1, color: "GLYPH_BROWN", glyphIcon: "damageIcon", description : "A damaging aura around the Infernal. Procs at the start of the Demonist's turn." },
        ...
        "zombie": {
            ...
            spells: [
                ...
                { name: "Zombie Attack", dealSpell: "zombie_attack", range: 1, rangeMin: 1, cooldown: 0, aoe: "single", canTarget: [TYPES.VULNERABLE] , description : "An instant attack that also kills the caster."},
                // { passive: true, cooldown: 0, name: "" },
                // { passive: true, cooldown: 0, name: "" },
            ]
        },
    ...
    CHARACTERS: [
        {
            ...
            description: "This skilled spellcaster commands the power of fire and ice, wielding the ability to unleash inferno strikes and freezing curses, while forcing enemies away with a powerful wave of energy.",
            spells: [
        ...
        },
        {
            ...
            description: "This ancient being is a living construct, wielding the power of the earth and the ability to summon magma walls and perform boulder smashes that can inflict devastating damage.",
            spells: [
        ...
        },
        {
            ...
            description: "This shadow-clad warrior is a master of deception, sneaking up on their enemies to land a deadly backstab, shooting them from a distance with a silent handgun, or disappearing in a cloud of smoke with their smoke bomb.",
            spells: [
        ...
        },
        {
            ...
            description: "This mysterious spiritualist commands an undead army, calling forth zombies with a single spell and spreading pestilence with a dark glyph. They can also curse their enemies with voodoo magic.",
            spells: [
                { name: "Undead Army", dealSpell: "summon", summon: "zombie", range: 1, rangeMin: 1, cooldown: 1, glyph: 1, aoe: "single", canTarget: [TYPES.EMPTY], color: 'GLYPH_DARK', glyphIcon: "tombstoneIcon", description: "Reveals a tombstone that summons a zombie next turn." },
        ...
        },
        {
            ...
            description: "This armored mammal is a fierce defender, capable of rolling into a spiky ball to deal damage, shielding themselves with a defensive stance, and setting booby traps to ensnare their enemies.",
            spells: [
                ...
                { name: "Booby Trap", dealSpell: "root", range: 2, cooldown: 2, aoe: "single", permanent: true, onlyFirst: true, glyph: 1, color: "GLYPH_GAZ", glyphIcon: "rootIcon", canTarget: [TYPES.EMPTY], description: "Drops a lasting trap that roots targets." },
            ]
        },
        {
            name: "Warrior",
            ...
            description: "This brave warrior is a skilled combatant, able to unleash powerful cleaves, protect allies with an aegis, and charge into battle to push their enemies back.",
            spells: [
                ...
                { name: "Charge", dealSpell: "warrior_charge", range: 4, rangeMin: 1, cooldown: 2, aoe: "straight_line", onlyFirst: true, canTarget: [TYPES.ENTITY], description: "Instantly charges, damages and pushes the first target in a straight line." },
            ]
        },
        {
            name: "Troll",
            ...
            description: "This mischievous creature is able to manipulate the battlefield with its magic, pushing, pulling, and swapping positions with its enemies and allies.",
            spells: [
        ...
        },
        {
            ...
            description: "This noxious being leaves a trail of poisonous gas wherever they go, and is able to increase their mobility and attack targets up close with a powerful shotgun blast.",
            spells: [
                { name: "Gas gas gas", dealSpell: "damage_others", range: 0, cooldown: 0, aoe: "single", glyph: 1, color: "GLYPH_GAZ", passive: true, permanent: true, onMove: true, selfCast: true, glyphIcon: "gasIcon", canTarget: [TYPES.ANY], description: "Passively leaves a trail of toxic gas behind him when moving (the caster is immune to the gas)." },
