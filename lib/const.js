...
const GAMEDATA = Object.freeze({
    ...
    CHARACTERS: [
        ...
        },
        {
            name: "Shaman",
            spells: [
                { name: "Undead Army", dealSpell: "summon", summon: "zombie", range: 1, rangeMin: 1, cooldown: 2, glyph:1, aoe: "single", canTarget: [TYPES.EMPTY], color: 'GLYPH_DARK', glyphIcon: "flowerIcon", description: "Plants a flower that summons a zombie next turn." },
