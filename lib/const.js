...
const GAMEDATA = Object.freeze({
            ...
            auras: [
                {
                    ...
                    glyph: 1,
                    color: "GLYPH_BROWN",
                    src: "./pics/spells/demonist_1.png"
                },
            ],
        },
        infernal: {
            ...
            auras: [
                {
                    ...
                    glyph: 1,
                    color: "GLYPH_PREVIEW",
                    src : "./pics/spells/time traveler_1.png",
                },
                {
                    name: "Explosion",
                    dealSpell: "damage",
        ...
        zombie: {
            ...
            spells: [
                //just an hud indication, this spell works with the aura
                {
                    ...
                    canTarget: [TYPES.ANY],
                    description: "Moves, or in close contact deals an instant attack that also kills the caster.",
                },
            ],
        },
    },
    ...
    LAVA_SPELL: {
        ...
        description : "Time is ticking and lava is rising! Choose a cell on the edge of the map to make it disappear in the lava."
    },
    PASS_SPELL: {
        name: "Pass turn",
    ...
    CHARACTERS: [
        ...
        },
        {
            ...
            description: "This magnificent beast commands the power of the skies, summoning bolts of lightning to scorch the earth and rooting its enemies in place with tempests. Its starfall silence also renders its foes powerless, making it a formidable opponent."  ,
                        spells: [
                {
                    name: "Heavenly Wrath",
                    dealSpell: "damage",
