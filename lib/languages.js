    ...
    fr: {
        ...
        characters: {
            mage: {
                ...
                description:
                    "Ce puissant lanceur de sorts commande le pouvoir du feu et de la glace, maniant la capacité de déchaîner des frappes infernales et de lancer des malédictions glacées, tout en repoussant les ennemis avec une puissante vague d'énergie.",
                spells: [
                    {
            ...
            assassin: {
                ...
                description:
                    "Cette mercenaire à l'ombre déguisée est une reine de la tromperie, se faufilant jusqu'à ses ennemis pour leur asséner un coup mortel, les abbattant de loin avec une arme à feu silencieuse ou disparaissant dans un nuage de fumée avec sa bombe fumigène.",
                spells: [
                    {
            ...
            time_traveler: {
                ...
                description: "Ce sorcier cosmique manipule le pouvoir du temps lui-même, capable d'invoquer des machines temporelles qui explosent et se téléportent, frappant les ennemis avec des coups arrière et les silence avec des lances de silence.",
                spells: [
                    {
                        name: "Machine temporelle",
