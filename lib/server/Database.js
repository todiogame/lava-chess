...
class Database {
    constructor() {
        ...
        //     // db.run("DROP TABLE USERS");
            this.db.run("CREATE TABLE IF NOT EXISTS USERS (id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT NOT NULL,email TEXT NOT NULL UNIQUE,password TEXT NOT NULL,connections INTEGER NOT NULL DEFAULT 0,last_login DATETIME DEFAULT CURRENT_TIMESTAMP,games_played INTEGER NOT NULL DEFAULT 0,rank INTEGER NOT NULL DEFAULT 0);");
        // });
    }
