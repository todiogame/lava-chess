...
module.exports = class Game {
  ...
  handleAction(client, action) {
    ...
    //     if (action.kind == "MOVE") {
    //       this.currentPlayer.loseMovePoint(); //use PM
    //       moveEntity(this.currentPlayer.entity, found)
    //     }
    //     else if (action.kind == "SPELL") {
    //       castSpell(og,this.currentPlayer.entity, this.currentPlayer.spells[action.spellID], found, action.direction);

    //     }
    //     else if (action.kind == "LAVA") {
    //       castSpell(og,this.currentPlayer.entity, c.GAMEDATA.LAVA_SPELL, found,)
    //       turnOrder.passTurn();
    //     }
    //   }
