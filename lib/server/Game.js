...
module.exports = class Game {
  constructor(clientA, clientB, gameMode, gameId) {
    ...
    if (gameMode == c.GAME_MODE.DRAFT)
      ...
      turnOrder.startTurnTimer(this.turnTimer,this.timeExpired)
    }
  ...
  handleAction(client, action) {
    if (action.kind == "LAVA" || action.kind == "PASS") {
    if (this.turnTimer.timeoutId) clearTimeout(this.turnTimer.timeoutId);
    // console.log("start timer for "+action.caster.name)
      turnOrder.startTurnTimer(this.turnTimer,this.timeExpired)
