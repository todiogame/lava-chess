...
module.exports = class Game {
    constructor(clientA, clientB, gameId) {
        ...
        if (clientB.nickname) Network.sendToClient(clientA, "INFO", { "nickname": this.clientB.nickname })
        if (clientA.nickname) Network.sendToClient(clientB, "INFO", { "nickname": this.clientA.nickname })
